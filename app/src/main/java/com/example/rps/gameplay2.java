...
public class gameplay2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enemyresult.setText(secondenemy);
    ...
    public void matchGame(int userSelection){
        ...
        //boolean b = (userSelection - enemySelection) % 3 == 1 || userSelection ==1 && enemySelection ==3;
